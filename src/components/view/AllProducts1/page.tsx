...
export default class AllProductsCompo extends Component <{ ProductData: propsType }>{
    ...
    fetchDataFromApiGradullay =async (start:number ,end:number)=>{
    ...
    getData = async () => {
        let allTogether = await this.fetchDataFromApiGradullay(this.start,this.end)
    ...
    render() {
        return (
            ...
            <InfiniteScroll
                ...
                className="grid grid-cols-1 md:grid-cols-2 py-10 lg:grid-cols-3 gap-3"
                >
